...
body {
  background-image: url("inc/guest.jpg");ing: antialiased;
...
<div id="loginModal" class="modal show" tabindex="10" role="dialog" aria-hidden="true" >
  <div class="modal-dialog">
  <div class="modal-content" style="padding:50px;">
      <div class="modal-header">
          <h2 class="text-center">Selamat Datang Di SMKN 5 Kota Bekasi</h2>
      </div>
      <?php
